...
TEST_CASE("Tensor * tensor component product", "[tensor]") {
    tensor<float, 2, 3> t1({ { 1.0f, 2.0f, 3.0f }, { 4.0f, 5.0f, 6.0f } });
    tensor<float, 2, 3> t2({ { 2.0f, 4.0f, 6.0f }, { 8.0f, 10.0f, 12.0f } });
    tensor<float, 2, 3> t3({ { 2.0f, 8.0f, 18.0f }, { 32.0f, 50.0f, 72.0f } });
...
TEST_CASE("Tensor + tensor addition", "[tensor]") {
    tensor<float, 2, 3> t1({ { 1.0f, 2.0f, 3.0f }, { 4.0f, 5.0f, 6.0f } });
    tensor<float, 2, 3> t2({ { 2.0f, 4.0f, 6.0f }, { 8.0f, 10.0f, 12.0f } });
    tensor<float, 2, 3> t3({ { 3.0f, 6.0f, 9.0f }, { 12.0f, 15.0f, 18.0f } });
    tensor<float, 2, 3> t4 = t1 + t2;
...
TEST_CASE("Tensor - tensor in-place subtraction", "[tensor]") {
    tensor<float, 2, 3> t1({ { 1.0f, 2.0f, 3.0f }, { 4.0f, 5.0f, 6.0f } });
    tensor<float, 2, 3> t2({ { 2.0f, 4.0f, 6.0f }, { 8.0f, 10.0f, 12.0f } });
    tensor<float, 2, 3> t3({ { 3.0f, 6.0f, 9.0f }, { 12.0f, 15.0f, 18.0f } });
    t3 -= t2;
...
TEST_CASE("Tensor - tensor subtraction", "[tensor]") {
    tensor<float, 2, 3> t1({ { 1.0f, 2.0f, 3.0f }, { 4.0f, 5.0f, 6.0f } });
    tensor<float, 2, 3> t2({ { 2.0f, 4.0f, 6.0f }, { 8.0f, 10.0f, 12.0f } });
    tensor<float, 2, 3> t3({ { 3.0f, 6.0f, 9.0f }, { 12.0f, 15.0f, 18.0f } });
...
TEST_CASE("Multiple index tensor summation", "[tensor]") {
    ...
    tensor<float, 2, 2, 2> expected_sum({
        { { (1.0f * 10.0f) + (2.0f * 30.0f) + (3.0f * 50.0f), (1.0f * 20.0f) + (2.0f * 40.0f) + (3.0f * 60.0f) },
          { (2.0f * 10.0f) + (3.0f * 30.0f) + (4.0f * 50.0f), (2.0f * 20.0f) + (3.0f * 40.0f) + (4.0f * 60.0f) } },
        { { (4.0f * 10.0f) + (5.0f * 30.0f) + (6.0f * 50.0f), (4.0f * 20.0f) + (5.0f * 40.0f) + (6.0f * 60.0f) },
          { (5.0f * 10.0f) + (6.0f * 30.0f) + (7.0f * 50.0f), (5.0f * 20.0f) + (6.0f * 40.0f) + (7.0f * 60.0f) } }
    });

    tensor<float, 2, 2, 2> sum = weyl::sum<1, 0>(t1, t2);
